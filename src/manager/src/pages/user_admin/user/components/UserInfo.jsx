        ...
        return (
            <Card title="基本信息" bordered={false} size="small">
                <Row gutter={[10, 20]}>
                    ...
                    <Col span={18}>{userInfo.user_name} </Col>
                </Row>
                <Row gutter={[10, 20]}>
                    <Col span={6} align="right">
                        用户昵称：
                    ...
                    <Col span={18}>
                        {userInfo.nick_name} {userInfo.vip_type ? <img title="已激活 VIP" style={{ width: 24 }} src={vipIcon} /> : null}
                    </Col>
                </Row>
                <Row gutter={[10, 20]}>
                    <Col span={6} align="right">
            ...
            <Card title="联系信息" bordered={false} size="small">
                ...
                <Row gutter={[10, 20]}>
                    ...
                    <Col span={18}>
                        {wxInfo ? (
                            <div>
                                <img src={wechatIcon} style={{ width: 24 }} /> {wxInfo.dis_name || wxInfo.account}
                            </div>
                        ) : null}
                        {weiboInfo ? (
                            <div style={{ marginTop: 10 }}>
                                <img src={qqIcon} style={{ width: 24 }} /> {weiboInfo.dis_name || weiboInfo.account}
                            </div>
                        ) : null}
                        {qqInfo ? (
                            <div style={{ marginTop: 10 }}>
                                <img src={weiboIcon} style={{ width: 24 }} /> {qqInfo.dis_name || qqInfo.account}
                            </div>
                        ) : null}
                        {alipayInfo ? (
                            <div style={{ marginTop: 10 }}>
                                <img src={alipayIcon} style={{ width: 24 }} /> {alipayInfo.dis_name || alipayInfo.account}
                            </div>
                        ) : null}
                    </Col>
                </Row>
    ...
    const renderRoleForm = () => {
        return (
            <Card title="角色权限" bordered={false} size="small">
                ...
                <Row gutter={[10, 20]}>
                    <Col span={6} align="right">
                        <Tooltip title="用户实际权限为角色权限+管理员设置权限">
