    ...
    render() {
        ...
        return (
            <PageHeaderWrapper>
                <Card>
                    <div style={{ width: '80%' }}>
                        <UserForm wrappedComponentRef={form => (this.userFormRef = form)} userInfo={this.props.currentUser} />
                    </div>
                </Card>
                <Card style={{ marginTop: -1 }}>
                    <Button
                        ...
                        onClick={async () => {
                            ...
                            if (userInfo) {
                                debugger
                                const result = await UserService.updateUser(userInfo.userId, userInfo)
                                if (result) {
