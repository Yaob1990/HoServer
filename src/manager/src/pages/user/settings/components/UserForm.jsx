            ...
            <Card title="基本信息" bordered={false} size="small">
                <LegacyForm.Item label="用户名">
                    {getFieldDecorator('userName', {
                        rules: [{ pattern: '^([A-Za-z0-9_\\-]){1,}$', message: '只允许英文字母数字和下划线' }],
                ...
                <LegacyForm.Item label="密码">
                    {getFieldDecorator('password', {
                        rules: [{ pattern: '^([~!@#$%^&*()+<>,.?/;\'":A-Za-z0-9_\\-]){1,}$', message: '只允许英文字母、符号、数字和下划线' }],
                    })(
                        <Input
                ...
                <LegacyForm.Item label="真实姓名">{getFieldDecorator('realName')(<Input />)}</LegacyForm.Item>
            </Card>
        )
    }
    ...
    renderContactlForm() {
        ...
        return (
            <Card title="联系信息" bordered={false} size="small">
                <LegacyForm.Item label="手机号码">{getFieldDecorator('mobile')(<Input />)}</LegacyForm.Item>
                <LegacyForm.Item label="电子邮件">{getFieldDecorator('email')(<Input />)}</LegacyForm.Item>
